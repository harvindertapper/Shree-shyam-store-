...
class LocalizationSourceQualityTest {
    ...
    fun localizedScreensDoNotContainMojibakeOrMixedTranslationCopy() {
        val targetFiles = listOf(
            "src/main/java/com/example/ui/screens/BillingAndPaymentScreen.kt",
            "src/main/java/com/example/ui/screens/ProductsAndStockScreen.kt",
            "src/main/java/com/example/ui/screens/ReportsScreen.kt",
            "src/main/java/com/example/ui/screens/UdhaarScreen.kt",
            "src/main/java/com/example/viewmodel/ShopViewModel.kt"
        )
