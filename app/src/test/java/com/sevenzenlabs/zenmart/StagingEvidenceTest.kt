...
import com.sevenzenlabs.zenmart.utils.StagingRehearsalEvidence
import com.sevenzenlabs.zenmart.utils.StagingRehearsalStage
import com.sevenzenlabs.zenmart.utils.StagingStageEvidence
import com.sevenzenlabs.zenmart.utils.StagingStageStatus
...
class StagingEvidenceTest {
    ...
    private fun validEvidence(): StagingRehearsalEvidence = StagingRehearsalEvidence(
        ...
        packageName = "com.sevenzenlabs.zenmart",
        appVersion = "1.0.0",
