...
import com.sevenzenlabs.zenmart.ui.screens.CustomReportRangeSelector
import com.sevenzenlabs.zenmart.ui.screens.ReportErrorState
import com.sevenzenlabs.zenmart.ui.screens.ReportIntervalTabs
import com.sevenzenlabs.zenmart.ui.screens.ReportLoadingState
...
class Issue56JourneySemanticsTest {
    ...
    private fun assertCriticalJourneySurfaces(language: AppLanguage) {
        ...
        composeTestRule.onNodeWithTag("mutation_retry_button")
            .performScrollTo()
            .assertIsDisplayed()
        composeTestRule.onNodeWithTag("journey_report_intervals")
            .performScrollTo()
            .assertIsDisplayed()
