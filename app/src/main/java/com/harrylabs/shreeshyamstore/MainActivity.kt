...
import com.harrylabs.shreeshyamstore.ui.screens.*
...
import com.harrylabs.shreeshyamstore.viewmodel.ShopViewModelFactory
                    ...
                    Scaffold(
                        ...
                        Box(
                            ...
                            when (val screen = currentScreen) {
                                ...
                                is Screen.AddEditProduct -> AddEditProductScreen(viewModel, screen.productUuid)
                                is Screen.OpeningStock -> OpeningStockScreen(viewModel)
                                is Screen.StockAdjustment -> StockAdjustmentScreen(viewModel, screen.productUuid)
